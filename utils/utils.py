...
def page_config(layout = "centered"):
    st.set_page_config(
        page_title="Bidding and Proposal Generator",
...
def template_end():
    with st.sidebar.expander("ℹ️ - About this App"):
        st.sidebar.markdown("This app uses Lyzr's Automata to Generate Bidding and Proposal for your specific Construction Projects")
